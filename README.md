...
-> Classify it with a single click

-> View the image directly in the UI

This is a complete end-to-end MATLAB deep learning demo suitable for learning, teaching, and showcasing on GitHub.
